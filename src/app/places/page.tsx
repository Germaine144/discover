...
const PlacesToVisit: React.FC = () => {
  ...
  const places: Place[] = [
    {
      ...
      googleMapsUrl: 'https://www.google.com/maps/dir//Kandt+House+Museum,+KN+90+St,+Kigali/@-1.9665432,30.124274,14z/data=!4m8!4m7!1m0!1m5!1m1!1s0x19dca43b665b7977:0x3ed0c77961ef7632!2m2!1d30.0532142!2d-1.9466888?entry=ttu&g_ep=EgoyMDI2MDEyMS4wIKXMDSoKLDEwMDc5MjA2N0gBUAM%3D'
    },
    {
      id: 2,
      name: 'Nature Kigali',
      ...
      googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Nature+Kigali+Nyarutarama'
    },
    {
      id: 3,
      ...
      googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Inzora+Rooftop+Cafe+Kacyiru+Kigali'
    },
    {
      id: 4,
      ...
      googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Kigali+Golf+Club+Nyarutarama'
    },
    {
      id: 5,
      ...
      googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Azizi+Life+Studio+Kimihurura+Kigali'
    },
    {
      id: 6,
      ...
      googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Nyarutarama+Lake+Kigali'
    },
    {
      id: 7,
      name: 'Poivre Noir',
      ...
      googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Poivre+Noir+Restaurant+Kiyovu+Kigali'
    },
    {
      id: 8,
      ...
      googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Inka+Steakhouse+Bar+Remera+Kigali'
    },
    {
      id: 9,
      ...
      priceRange: 'Free entry',
      googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Green+Park+Gahanga+Kicukiro+Kigali'
    },
    {
      id: 10,
      name: 'Kacyiru Park',
      ...
      priceRange: 'Free entry',
      googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Kacyiru+Park+Gasabo+Kigali'
    },
    {
      id: 11,
      name: 'Ivuka Art',
      ...
      googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Ivuka+Art+Gallery+Kacyiru+Kigali'
    },
    {
      id: 12,
      ...
      googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=Soy+Restaurant+Lounge+Kimihurura+Kigali'
    },
  ];
  ...
  const openGoogleMaps = (place: Place) => {
    if (place.googleMapsUrl) {
      ...
      // Fallback to search by address if direct URL not available
